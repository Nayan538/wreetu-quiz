<div class="sidebar__menu-group">
    <ul class="sidebar_nav">
        {{-- <li class="has-subchild {{ Request::is(app()->getLocale().'/dashboards/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/applications/email/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/applications/ecommerce/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/applications/project/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/applications/user/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/applications/contact/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/applications/import_export/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/applications/social/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/pages/course/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/applications/support/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/applications/job/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/table/*') || Request::is(app()->getLocale().'/pages/dynamic-table') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/customer/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/ui/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/chart/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/form/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/widget/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/wizard/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/icon/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/map/*') ? 'open':'' }}">
        ...
        <li class="has-subchild {{ Request::is(app()->getLocale().'/pages/gallery/*') ? 'open':'' }}">
        ...
        {{-- @if (hasPermission('services.*'))
            <li class="has-child {{ request()->routeIs('services.*') ? 'open' : '' }}">
                <a href="#" class="{{ request()->routeIs('services.*') ? 'active' : '' }}">
                    <span class="nav-icon fas fa-server"></span>
                    <span class="menu-text">{{ t_('menu.services') }}</span>
                    <span class="toggle-icon"></span>
                </a>
                <ul>
                    @foreach (config('services') as $service)
                        <li><a href="{{ route('services.index', ['type' => $service['route_name']]) }}"
                                class="{{ request()->routeIs('services.index') && request()->route('type') == $service['route_name'] ? 'active' : '' }}">
                                <span class="nav-icon {{ $service['icon'] }}" style="margin-right: 20px;"></span>
                                {{ t_($service['menu_name']) }}</a>
                        </li>
                    @endforeach
                </ul>
            </li>
                ...
                <ul>
                        ...
                        <li class="has-subchild {{ request()->routeIs('sms.*') ? 'open' : '' }}">
                            ...
                            <ul>
                                @if (hasPermission('sms.templates.index'))
                                    <li><a href="{{ route('sms.templates.index') }}"
                                            class="{{ request()->routeIs('sms.templates.*') ? 'active' : '' }}">
                                            {{ t_('menu.sms-templates') }}</a>
                                    </li>
                                @endif
                                @if (hasPermission('sms.service-names.index'))
                                    <li><a href="{{ route('sms.service-names.index') }}"
                                            class="{{ request()->routeIs('sms.service-names.*') ? 'active' : '' }}">
                                            {{ t_('menu.service-names') }}</a>
                                    </li>
                                @endif
                                @if (hasPermission('sms.trigger-names.index'))
                                    <li><a href="{{ route('sms.trigger-names.index') }}"
                                            class="{{ request()->routeIs('sms.trigger-names.*') ? 'active' : '' }}">
                                            {{ t_('menu.trigger-names') }}</a>
                                    </li>
                                @endif
                        ...
                        <li class="has-subchild {{ request()->routeIs('access_control.branchs.*') || request()->routeIs('access_control.branch-types.*') ? 'open' : '' }}">
                            ...
                            <ul>
                                @if (hasPermission('access_control.branchs.index'))
                                    <li><a href="{{ route('access_control.branchs.index') }}"
                                            class="{{ request()->routeIs('access_control.branchs.*') ? 'active' : '' }}">
                                            <span class="nav-icon fas fa-code-branch" style="margin-right: 20px;"></span>
                                            {{ t_('menu.branch-menu-title') }}</a>
                                    </li>
                                @endif

                                @if(hasPermission('access_control.branch-types.index'))
                                    <li>
                                        <a href="{{ route('access_control.branch-types.index') }}" class="{{ request()->routeIs('access_control.branch-types.*') ? 'active' : '' }}">
                                            <span class="nav-icon fas fa-code-branch" style="margin-right: 20px;"></span>
                                            {{ t_('menu.branch-type-menu-title') }}
                                        </a>
                                    </li>
                                @endif
                    ...
                    @if (hasPermission('access_control.roles.*'))
                        <li class="has-subchild {{ request()->routeIs('access_control.roles.*') ? 'open' : '' }}">
                            <a href="#"
                                class="{{ request()->routeIs('access_control.roles.*') ? 'active' : '' }}">
                            ...
                            <ul>
                                @if (hasPermission('access_control.roles.create'))
                                    <li><a href="{{ route('access_control.roles.create') }}"
                                            class="{{ request()->routeIs('access_control.roles.*') ? 'active' : '' }}">{{ t_('menu.create-role-menu-title') }}</a>
                                    </li>
                                @endif
                                @if (hasPermission('access_control.roles.index'))
                                    <li><a href="{{ route('access_control.roles.index') }}"
                                            class="{{ request()->routeIs('access_control.roles.*') ? 'active' : '' }}">{{ t_('menu.role-list-menu-title') }}</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                    ...
                    @if (hasPermission('notifications.*'))
                        <li>
                            <a href="{{ route('notifications.general-notifications.index') }}"
                                class="has-child {{ request()->routeIs('notifications.general-notifications.*') ? 'active' : '' }}">
                                <span
                                    class="nav-icon uil uil-bell"></span>{{ t_('menu.general-notification-menu-title') }}
                            </a>
                        </li>
                    @endif
                    @if (hasPermission('history.*'))
                        <li>
                            <a href="{{ route('history.user-log-histories.index') }}"
                                class="has-child {{ request()->routeIs('history.user-log-histories.*') ? 'active' : '' }}">
                                <span
                                    class="nav-icon uil uil-clock"></span>{{ t_('menu.user-log-history-menu-title') }}
                            </a>
                        </li>
                    @endif
                    @if (hasPermission('access_control.global-settings.*'))
                        <li>
                            <a href="{{ route('access_control.global-settings.edit', 1) }}"
                                class="has-child {{ request()->routeIs('access_control.global-settings.*') ? 'active' : '' }}">
                                <span class="nav-icon uil uil-cog"></span>{{ t_('Global Settings') }}
                            </a>
                        </li>
                    @endif
                </ul>
