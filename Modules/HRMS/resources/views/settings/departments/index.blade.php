...
@section('description', 'Departments')
@extends('layout.app')
@section('content')
@section('content')
    <!-- CONTENT AREA -->
                        ...
                        <div class="breadcrumb-action justify-content-center flex-wrap">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{ trans(' Departments') }}</li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-bottom: 20px">
                    <div class="row" style="width: 100%">
                        <div class="col-md-6">
                            <h4 class="text-capitalize breadcrumb-title">{{ trans('Departments') }}</h4>
                        </div>
                    </div>
                    <x-error-alart />
                </div>
